    ...
    providers: [
        {
            ...
            useExisting: forwardRef(() => { DraggableCheckboxComponent }),
            multi: true
        }
    ]
})
export class DraggableCheckboxComponent extends DraggableItemComponent implements ControlValueAccessor {
